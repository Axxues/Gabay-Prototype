            ...
            <div className="pt-3 border-t border-border/80 flex flex-wrap items-center justify-between gap-4 text-xs">
              <div className="flex flex-wrap items-center gap-3">
                ...
                <div className="flex items-center space-x-2 bg-muted/40 px-3 py-1.5 rounded-xl border border-border">
                  <label htmlFor="exam-term-select" className="font-bold text-foreground select-none">
                    Term:
                  </label>
                  <select
                    id="exam-term-select"
                    ...
                    className="px-2 py-1 bg-background border border-border rounded-lg text-xs font-bold text-foreground outline-none focus:ring-2 focus:ring-primary/20 cursor-pointer"
                  >
